...
Here, I am looking at the physiological response of a subset of *S. siderea* samples that were also assessed for transcriptomic analyses. From the TagSeq data, we were able to identify relative abundance of Symbiodinacaea genus within each fragment as either *Cladocopium spp.* dominated (> 50% reads mapping to *Cladocopium*) or *Durusdinium spp.* dominated (> 50% reads mapping to *Durusdinium*). We then used this information to assess differences in physiological responses based on dominant Symbiodinacaea genera.
...
s_sub_pca_mod <- adonis2(sid_sub_pca_df ~ fpco2 + ftemp + reef + domSymb + reef:ftemp + ftemp:domSymb + fpco2:domSymb , data = s_df, method = 'eu', permutations = bootnum)
...
```{r SSID subset PCA all plots, eval=FALSE, include=FALSE}

ggarrange(s_sub_symb_pca, s_sub_pco2_pca, s_sub_temp_pca, s_sub_reef_pca, ncol = 2,  nrow = 2)
