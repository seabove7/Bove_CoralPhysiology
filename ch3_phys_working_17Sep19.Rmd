...
comp.fig <-ggplot(comp.sum, aes(colour=treat, shape = treat))+
  ...
  xlab("time point")+
  ylab("")+
  geom_point(data=df.comp, aes(T0_T90, value), position = dodge2, alpha=0.3, size=1)+
  geom_linerange(aes(x = T0_T90, ymin=value-se, ymax=value+se, colour=treat), position=dodge2)+
