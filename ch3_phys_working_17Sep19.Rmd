---
title: "Chapter3_Physiology_working"
author: "CBB"
date: "9/17/2019"
...
df$treat <- factor(df$treat, c("288_28", "311_31", "447_28", "405_31", "673_28", "701_31", "3285_28", "3309_31"))
...
comp.fig <-ggplot(comp.sum, aes(colour=treat, shape = treat))+
  ...
  xlab("time point")+
  ylab("")+
  geom_errorbar(aes(x = T0_T90, ymin=value-se, ymax=value+se, width=0.5), position=dodge2, colour="black")+
  geom_point(aes(T0_T90, value), position = dodge2, size=2)+
  scale_colour_manual("Treatment", labels=c("280_28", "280_31", "400_28", "400_31", "700_28", "700_31", "2800_28", "2800_31"), values = c("blue", "red","blue", "red","blue", "red","blue", "red"))+
  scale_shape_manual("Treatment", labels=c("280_28", "280_31", "400_28", "400_31", "700_28", "700_31", "2800_28", "2800_31"), values = c(18, 18, 15, 15, 16, 16, 17, 17))+
  facet_grid(param~species, scales = "free_y", labeller = as_labeller( c(chla = "Chlorophyll \n (ug/cm2)", den = "Symbiont Density \n (10^6 cells cm2)", pro = "Total Protein \n (mg/cm2)", carb = "Carbohydrate \n (mg/cm2)", S = "SSID", P = "PSTR", A = "PAST", T = "UTEN")))
comp.fig
