...
T90.pca <- prcomp(df.90[,14:19], center = TRUE, scale= TRUE)
summary(T90.pca)

species.pca <- ggbiplot(T90.pca, ellipse = TRUE, groups = df.90$species) 
species.pca
...
# reef environment
s.reef.pca <- ggbiplot(s.pca, ellipse = TRUE, groups = s.df$reef)
s.reef.pca

# temperature
s.temp.pca <- ggbiplot(s.pca, ellipse = TRUE, groups = s.df$ftemp) 
s.temp.pca

# pco2
s.pco2.pca <- ggbiplot(s.pca, ellipse = TRUE, groups = s.df$fpco2) 
s.pco2.pca
...
# reef environment
p.reef.pca <- ggbiplot(p.pca, ellipse = TRUE, groups = p.df$reef) 
p.reef.pca

# temperature
p.temp.pca <- ggbiplot(p.pca, ellipse = TRUE, groups = p.df$ftemp) 
p.temp.pca

# pco2
p.pco2.pca <- ggbiplot(p.pca, ellipse = TRUE, groups = p.df$fpco2) 
p.pco2.pca



#### P. astreoides PCAs
a.df <- subset(df.90, species == "S") 
...
# reef environment
a.reef.pca <- ggbiplot(a.pca, ellipse = TRUE, groups = a.df$reef) 
a.reef.pca

# temperature
a.tema.pca <- ggbiplot(a.pca, ellipse = TRUE, groups = a.df$ftemp) 
a.tema.pca

# pco2
a.pco2.pca <- ggbiplot(a.pca, ellipse = TRUE, groups = a.df$fpco2) 
a.pco2.pca

# treat
a.treat.pca <- ggbiplot(a.pca, ellipse = TRUE, groups = a.df$treat2) 
a.treat.pca
