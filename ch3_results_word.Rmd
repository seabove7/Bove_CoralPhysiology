...
plot_grid(s.temp.pca, s.pco2.pca, ncol = 3, scale = 0.8)
...
plot_grid(p.temp.pca, p.pco2.pca, ncol = 3, scale = 0.8)

#p.pca.mod

```

#### **C |** *Porites astreoides*
...
plot_grid(a.tema.pca, a.pco2.pca, ncol = 3, scale = 0.8)
