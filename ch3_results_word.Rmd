...
> *Need a statement about PCAs* (**Figure 2**)
...
> This will discuss overall responses and the WGCNA here. *-- This will be excluded from my dissertation, but included in the manuscript*
...
a.pca.mod <- adonis(value ~ ftemp + fpco2 + reef + ftemp:fpco2, data = a.df.l, method='eu')
...
# Figure 3: Gene expression by reef environment

![**A | ** Host gene expression by treatment](/Users/Colleen/ch3_phys_working/Host_PCA_03Jan20.png)


![**B | ** Endosymbiont gene expression by treatment](/Users/Colleen/ch3_phys_working/Symbiont_PCA_03Jan20.png)

<br/>

# Figure 4: Differentially expressed genes by treatment

![**A | ** Host significantly differentially expressed genes](/Users/Colleen/ch3_phys_working/Host_DEG_03Jan20.png)

![**B | ** Endosymbiont significantly differentially expressed genes](/Users/Colleen/ch3_phys_working/Symbiont_DEG_03Jan20.png)
