...
**Figure S3.** Coral colour change over experimental period. Representative images of fragments of *P. astreoides* (**A**), *S. siderea* (**B**), and *P. strigosa* (**C**) from the same colonies demonstrating change in coral colour over time in either control (400 μatm; 28 °C) or warming (400 μatm; 31 °C) treatments from the start of the experiment (T0) to the end (T90).
...
**Table S1.** Akaike information criterion (AIC) generalized linear model (GLM) selection comparisons for plasticity assessments to select the best-fit model per species.
