...
**Figure S6.** Mean ($\pm$SE) physiological parameter (each row) measured for (**A**) *S. siderea*, (**B**) *P. strigosa*, (**C**) *P. astreoides*, and (**D**) *U. tenuifolia* at the completion of the 93-day experimental period. *p*CO~2~ treatment is represented along the x axis and the temperature is depicted by color (28$^\circ$C blue; 31$^\circ$C red).
...
autoplot(all_pca, data = all_df, 
  ...
  ggsave("Figures/Supplemental_Figures/FigureS8_speciesPCA_reef.pdf", width = 5.5, height = 4.5) +
  ggsave("Figures/Supplemental_Figures/FigureS8_speciesPCA_reef.png", width = 5.5, height = 4.5)
