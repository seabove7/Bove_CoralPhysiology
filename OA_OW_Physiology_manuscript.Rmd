...
s_pco2_pca <- autoplot(s_pca, data = s_df, 
    ...
    annotate("text", x = -0.27, y = -0.38, label = deparse(s_pco2_pval), parse = TRUE, size = 3)
...
# ellipse by pco2
s_pco2_pca2 <- autoplot(s_pca, data = s_df, 
         colour = "fpco2",
         shape = "ftemp",
         frame = FALSE, 
         loadings = TRUE, 
    ...
    scale_color_manual("", labels = c("pre industrial", "current", "end-of-century", "extreme"), values = c("#b2abd2", "#5e3c99", "#fdb863", "#e66101")) +
    guides(linetype = "none", shape = guide_legend(order = 1, nrow = 2)) +
    guides(color = guide_legend(order = 2, nrow = 2, override.aes = list(linetype = c(0, 0, 0, 0)))) +
...
a_pco2_pca <- autoplot(a_pca, data = a_df, 
    ...
    guides(color = guide_legend(nrow = 4, override.aes = list(linetype = c(0, 0, 0, 0)))) +
    theme(legend.background = element_rect(fill = "transparent", color = NA)) +
  annotate("text", x = -0.160, y = -0.5, label = deparse(a_pco2_pval), parse = TRUE, size = 3)
...
ggarrange(temp_PCA, pCO2_PCA, nrow = 2) 
  ggsave("Figures/Final_Figures/Figure1_PhysPCA.pdf", width = 10, height = 7)
  ggsave("Figures/Final_Figures/Figure1_PhysPCA.png", width = 10, height = 7)
