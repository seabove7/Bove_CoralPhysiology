...
ggarrange(all_reef_pca, all_pt_pca, ncol = 2, labels = "AUTO", widths = c(0.6, 1))
  ggsave("Figures/Supplemental_Figures/FigureS21_speciesPCA.pdf", width = 10, height = 4.5)
  ggsave("Figures/Supplemental_Figures/FigureS21_speciesPCA.png", width = 10, height = 4.5)
