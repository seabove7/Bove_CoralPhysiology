...
p_pca_plot <- autoplot(p_pca, data = p_df, 
  ...
  guides(linetype = "none", shape = guide_legend(keyheight = 0.7, keywidth = 0.1, order = 2, nrow = 4)) +
  ...
  theme(legend.background = element_rect(fill = "transparent", color = NA), legend.position = c(0.18, 0.95))

guide_temp_color <- get_legend(p_pca_plot + guides(linetype = "none", shape = "none")) # extract the temp colour legend

p_pca_plot <- p_pca_plot + # add colour guide to new location and save
  guides(color = "none") +
  annotation_custom(guide_temp_color, xmax = 0.95, ymax = -0.25)
...
ggarrange(s_pca_plot, p_pca_plot, a_pca_plot, ncol = 3, labels = c("A", "B", "C")) + 
  ...
  ggsave("Figures/Final_Figures/Figure1_PhysPCA.pdf", width = 14, height = 4, dpi = 1200)
  ggsave("Figures/Final_Figures/Figure1_PhysPCA.png", width = 14, height = 4, dpi = 1200)
  ggsave("Figures/Final_Figures/Figure1_PhysPCA.tiff", width = 14, height = 4, dpi = 1200)
