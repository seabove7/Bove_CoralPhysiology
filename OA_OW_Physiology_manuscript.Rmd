---
title: "Global Change Alters Coral Holobiont Physiology And Suggests Future Shifts In Caribbean Coral Reef Diversity"
...
**Figure 3.** Assessment of phenotypic plasticity of (**A**) *S. siderea*, (**B**) *P. strigosa*, and (**C**) *P. astreoides* in experimental treatments and by natal reef environment. Higher values represent greater plasticity in coral holobiont samples. *p*CO~2~ treatment is depicted by colour and shape (280 $\mu$atm light purple, circle; 400 $\mu$atm dark purple, diamond; 700 $\mu$atm light orange, triangle; 2800 $\mu$atm dark orange, square) and temperature is represented as either filled (28$^\circ$C) or open (31$^\circ$C) symbols.
...
ggplot(df_withT_phys, aes(x = fpco2, y = value, colour = ftemp)) +
  ...
  scale_colour_manual("", labels = c("28 °C", "31 °C"), values = c("#4393c3", "#b2182b"))+
  facet_grid(param ~ species, scales = "free_y", labeller = label_parsed) +
  guides(color = guide_legend(override.aes = list(linetype = c(0, 0)))) +
  labs(y = "", x = alab) +
  ggsave("Figures/Supplemental_Figures/FigureS2_AllPhysiology.pdf", width = 10, height = 13) +
  ggsave("Figures/Supplemental_Figures/FigureS2_AllPhysiology.png", width = 10, height = 13) 

```

**Figure S2.** Mean ($\pm$SE) physiological parameter (each row) measured for (**A**) *S. siderea*, (**B**) *P. strigosa*, (**C**) *P. astreoides*, and (**D**) *U. tenuifolia* at the completion of the 93-day experimental period. 
...
![](Figures/Supplemental_Figures/FigureS3_BleachingImages.png)

**Figure S3.** Coral colour changes over the experimental period. Representative images of fragments of (**A**) *P. astreoides*, (**B**) *S. siderea*, and (**C**) *P. strigosa* from the same colonies demonstrating change in coral colour over time in either control (400 μatm; 28 °C) or warming (400 μatm; 31 °C) treatments from the start of the experiment (T0) to the end (T90).
...
autoplot(all_pca, data = all_df, 
  ...
  ggsave("Figures/Supplemental_Figures/FigureS4_speciesPCA_reef.pdf", width = 5.5, height = 4.5) +
  ggsave("Figures/Supplemental_Figures/FigureS4_speciesPCA_reef.png", width = 5.5, height = 4.5)
...
ggarrange(ssid_host_symb_temp, ssid_host_symb_pco2, ssid_host_symb_reef, nrow = 3) +
  #ggsave("Figures/Supplemental_Figures/FigureS5_SSID_PCA_hostVsymb.pdf", width = 9, height = 10) +
  ggsave("Figures/Supplemental_Figures/FigureS5_SSID_PCA_hostVsymb.png", width = 9, height = 10)


```

**Figure S5.** SSID coral host versus algal symbiont physiology PCAs
...
s_pca_host_mod <- adonis2(dip_pca_df_host ~ fpco2 + ftemp + reef, data = p_df, method = 'eu', permutations = bootnum)
s_pca_host_mod # view PSTR adonis output
...
s_pca_symb_mod <- adonis2(dip_pca_df_symb ~ fpco2 + ftemp + reef, data = p_df, method = 'eu', permutations = bootnum)
s_pca_symb_mod # view PSTR adonis output


## perform principal component analysis (PCA)
s_pca_host <- prcomp(dip_pca_df_host, center = TRUE, scale= TRUE)
s_pca_symb <- prcomp(dip_pca_df_symb, center = TRUE, scale= TRUE)
...
## Temperature PCAs
# HOST temperature
dip_host_temp_pca <- autoplot(s_pca_host, data = p_df, 
                              colour = "ftemp",
                              #shape = "fpco2",
                              shape = "ftemp",
                              fill = "ftemp",               
...
# SYMB temperature
dip_symb_temp_pca <- autoplot(s_pca_symb, data = p_df, 
                              colour = "ftemp",
                              #shape = "fpco2",
                              shape = "ftemp",
                              fill = "ftemp",               
...
## pCO2 PCAs
# HOST pco2
dip_host_pco2_pca <- autoplot(s_pca_host, data = p_df, 
                              colour = "fpco2",
                              #shape = "ftemp",
                              fill = "fpco2",
                              shape = "fpco2",
...
# SYMB pco2
dip_symb_pco2_pca <- autoplot(s_pca_symb, data = p_df, 
                              colour = "fpco2",
                              #shape = "ftemp",
                              fill = "fpco2",
                              shape = "fpco2",
...
## Reef PCAs
# HOST reef
dip_host_reef_pca <- autoplot(s_pca_host, data = p_df,  
                              colour = "reef",
                              fill = "reef",
                              frame = TRUE, 
                              frame.type = "t", # displaying ellipses with multivariate t-distributions for small n producing heavier tails
...
# SYMB reef
dip_symb_reef_pca <- autoplot(s_pca_symb, data = p_df,  
                              colour = "reef",
                              fill = "reef",
                              frame = TRUE, 
                              frame.type = "t", # displaying ellipses with multivariate t-distributions for small n producing heavier tails
...
ggarrange(PSTR_host_symb_temp, PSTR_host_symb_pco2, PSTR_host_symb_reef, nrow = 3) +
  #ggsave("Figures/Supplemental_Figures/FigureS6_PSTR_PCA_hostVsymb.pdf", width = 9, height = 10) +
  ggsave("Figures/Supplemental_Figures/FigureS6_PSTR_PCA_hostVsymb.png", width = 9, height = 10)


```

**Figure S6.** PSTR coral host versus algal symbiont physiology PCAs
...
s_pca_host_mod <- adonis2(por_pca_df_host ~ fpco2 + ftemp + reef, data = a_df, method = 'eu', permutations = bootnum)
s_pca_host_mod # view PAST adonis output
...
s_pca_symb_mod <- adonis2(por_pca_df_symb ~ fpco2 + ftemp + reef, data = a_df, method = 'eu', permutations = bootnum)
s_pca_symb_mod # view PAST adonis output


## perform principal component analysis (PCA)
s_pca_host <- prcomp(por_pca_df_host, center = TRUE, scale= TRUE)
s_pca_symb <- prcomp(por_pca_df_symb, center = TRUE, scale= TRUE)
...
## Temperature PCAs
# HOST temperature
por_host_temp_pca <- autoplot(s_pca_host, data = a_df, 
                              colour = "ftemp",
                              #shape = "fpco2",
                              shape = "ftemp",
                              fill = "ftemp",               
...
# SYMB temperature
por_symb_temp_pca <- autoplot(s_pca_symb, data = a_df, 
                              colour = "ftemp",
                              #shape = "fpco2",
                              shape = "ftemp",
                              fill = "ftemp",               
...
## pCO2 PCAs
# HOST pco2
por_host_pco2_pca <- autoplot(s_pca_host, data = a_df, 
                              colour = "fpco2",
                              #shape = "ftemp",
                              fill = "fpco2",
                              shape = "fpco2",
...
# SYMB pco2
por_symb_pco2_pca <- autoplot(s_pca_symb, data = a_df, 
                              colour = "fpco2",
                              #shape = "ftemp",
                              fill = "fpco2",
                              shape = "fpco2",
...
## Reef PCAs
# HOST reef
por_host_reef_pca <- autoplot(s_pca_host, data = a_df,  
                              colour = "reef",
                              fill = "reef",
                              frame = TRUE, 
                              frame.type = "t", # displaying ellipses with multivariate t-distributions for small n producing heavier tails
...
# SYMB reef
por_symb_reef_pca <- autoplot(s_pca_symb, data = a_df,  
                              colour = "reef",
                              fill = "reef",
                              frame = TRUE, 
                              frame.type = "t", # displaying ellipses with multivariate t-distributions for small n producing heavier tails
...
ggarrange(PAST_host_symb_temp, PAST_host_symb_pco2, PAST_host_symb_reef, nrow = 3) +
  #ggsave("Figures/Supplemental_Figures/FigureS7_PAST_PCA_hostVsymb.pdf", width = 9, height = 10) +
  ggsave("Figures/Supplemental_Figures/FigureS7_PAST_PCA_hostVsymb.png", width = 9, height = 10)


```

**Figure S7.** PAST coral host versus algal symbiont physiology PCAs
