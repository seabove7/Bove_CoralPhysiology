---
title: "Global change modulates physiological plasticity of tropical reef-building corals"
...
sid_dist <- PCAplast(pca = s_pca, data = s_df)
...
```{r host v symb plasticity plots, fig.width = 7, fig.height = 8}
