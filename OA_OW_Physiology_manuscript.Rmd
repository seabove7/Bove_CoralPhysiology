...
all_reef_pca <- autoplot(all_pca, data = all_df, 
  ...
  ggsave("Figures/Supplemental_Figures/FigureS4_speciesPCA_reef.pdf", width = 6, height = 4.5) +
  ggsave("Figures/Supplemental_Figures/FigureS4_speciesPCA_reef.png", width = 6, height = 4.5) +
